...
//                InteriorNode interior1 = graph.getInteriors().stream().filter(x -> x.getCoordinates().equals(new Coordinates(66.6666666, 33.33333333, 100))).findFirst().get();
//                InteriorNode interior2 = graph.getInteriors().stream().filter(x -> x.getCoordinates().equals(new Coordinates(33.33333333, 66.6666666, 100))).findFirst().get();
//
//                t.transform(graph, interior1, interior2);

public class MainP6_P7 {
    public static void main(String[] args) {
        final GraphModel graph = createStartingGraph13();
